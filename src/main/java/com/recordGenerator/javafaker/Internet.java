...
import com.recordGenerator.javafaker.service.FakerIDN;
...
public class Internet {
    ...
    public String privateIpV4Address() {
        ...
        final com.recordGenerator.javafaker.service.RandomService r = faker.random();
    ...
    /**
     * @return a slug using '_' as the word separator and two {@link com.recordGenerator.javafaker.Lorem} words as the values
     */
    public String slug() {
    ...
    /**
     * @param wordsOrNull if null, then 2 {@link com.recordGenerator.javafaker.Lorem} words
