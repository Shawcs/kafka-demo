...
//
    public String creditCard() {
        com.recordGenerator.javafaker.CreditCardType type = randomCreditCardType();
    ...
    private com.recordGenerator.javafaker.CreditCardType randomCreditCardType() {
        return com.recordGenerator.javafaker.CreditCardType.values()[this.faker.random().nextInt(com.recordGenerator.javafaker.CreditCardType.values().length)];
    }
