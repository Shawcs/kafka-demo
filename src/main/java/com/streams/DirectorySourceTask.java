 ...
 */
public abstract class DirectorySourceTask extends SourceTask {
    ...
    private String topic="Ticket";//TODO change that to a signature or dynamically taken
...
/*    @Override
    ...
    private List<SourceRecord> createUpdateRecord(File file) {
        ...
        // creates the structured message
        Struct messageStruct = new Struct(schema);
        messageStruct.put("name", file.getName());//name of the file
        messageStruct.put("path", file.getPath());//change to the path name
